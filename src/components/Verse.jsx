...
import backgroundImage from '../assets/tree2.jpg'; // Replace with your image path
    ...
    <div className="relative flex items-center justify-center h-[900px] md:h-[700px] w-full  ">
      ...
      <div 
        ...
        style={{
          ...
          opacity: 1.5, // Adjust this value to control the image opacity
      ...
      <div className=" text-white px-4 md:px-8 lg:px-16 z-10 ">
        ...
        يَا أَيُّهَا النَّاسُ إِنَّا خَلَقْنَاكُم مِّن ذَكَرٍ وَأُنثَى وَجَعَلْنَاكُمْ شُعُوبًا وَقَبَائِلَ<br />
        ...
        <p className="text-xl md:text-2xl lg:text-3xl  md:font-medium leading-relaxed">
          “O mankind! WE created you from a single soul, male and female, and made you into nations and tribes, so <br />
          that you may come to know one another. Truly, the most honored of you in the sight of ALLAH is the greatest <br />
